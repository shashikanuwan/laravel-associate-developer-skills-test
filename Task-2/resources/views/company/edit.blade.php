            ...
            <form action="{{ route('company.update', $company) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$company->name}}" autofocus />
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <x-jet-input id="logo" class="block mt-1 w-full" type="file" name="logo"  value="{{$company->logo}}" autofocus />
                    </div>
                    <div class="w-full md:w-1/2 px-3">
